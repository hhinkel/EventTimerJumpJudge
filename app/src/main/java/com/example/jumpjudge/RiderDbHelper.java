...
public class RiderDbHelper extends  SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String SQL_CREATE_RIDER_TABLE =  "CREATE TABLE " + RiderContract.RiderEntry.TABLE_NAME + " ("
                ...
                + RiderContract.RiderEntry.COLUMN_FENCE_NUM + " INTEGER NOT NULL, "
                + RiderContract.RiderEntry.COLUMN_RIDER_REFUSALS + " INTEGER DEFAULT 0, "
                + RiderContract.RiderEntry.COLUMN_RIDER_TIME + " INTEGER NOT NULL, "
                + RiderContract.RiderEntry.COLUMN_RIDER_OTHER + " TEXT NOT NULL, "
                + RiderContract.RiderEntry.COLUMN_RIDER_HOLD + " INTEGER DEFAULT 0, "
